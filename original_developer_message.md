# Original Developer Note

After 6 years, it has to be sadly announced that the project has been discontinued due to the changes in my personal life, and I lost the motivation to continue this project. I don't have the opportunity to get back to working on this anymore.
...
The source code and assets are provided under download links. The project is based on C#; use Visual Studio 2019 or above to use it. Please feel free to continue developing with it. I wish you good luck.

Bitbucket server will be shut down at the end of 2022 (Jan 1, 2023 00:00). Users who use older versions will no longer receive update notifications. Bitbucket became a horrible service anyway, so there is no point in keeping it up anymore.
